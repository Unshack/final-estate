...
export default function Navbar() {
  ...
  const { darkMode, isSidebarOpen } = useSelector(userStore);
  ...
  return (
    ...
    >
      <Link to='/' className='flex-shrink-0 flex-align-center gap-x-1'>
        <HiBuildingOffice2 className='text-3xl text-primary' />
        <h1 className='hidden md:block'>Gallant Homes</h1>
      </Link>
      ...
      <div className='flex-align-center gap-x-4'>
        ...
        <div className='space-x-2 flex-align-center'>
          ...
          <Link to='/profile'>
            {currentUser ? (
              <img
                className='bg-white shadow-md icon-box dark:bg-dark-light hover:shadow-lg hover:bg-transparent object-cover'
