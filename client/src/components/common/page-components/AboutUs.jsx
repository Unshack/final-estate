    ...
    <div className="pt-16 pb-20">
      <div className="flex flex-wrap gap-24">
        ...
        <div className="relative flex-1 basis-[22rem]">
          ...
          <p className="mt-3">
          We specialize in transforming your living spaces into enchanting and personalized havens that reflect your unique style and personality. Our team of skilled designers and decorators is dedicated to enhancing your home environment.
          </p>
          <div className="mt-4">
