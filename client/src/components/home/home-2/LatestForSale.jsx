...
import CardHoverIcons from "../../common/page-components/CardHoverIcons";
        ...
        {property
          ...
          ?.map(
            ({
              ...
              <div className="relative grid grid-cols-1 gap-3 mt-3 overflow-hidden border rounded-lg shadow-light sm:grid-cols-3 dark:border-card-dark group" key={name}>
